...
public class ConnectionService extends IntentService implements BluetoothAdapter.LeScanCallback {
	...
	private BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
		...
		public void onConnectionStateChange(BluetoothGatt gatt, int status,
			...
			Log.wtf("connection state change", status + " -> "
			...
			if (status == BluetoothGatt.GATT_SUCCESS
				...
				try {
					String url = "http://"
							+ GLASSFISH_IP
							+ ":8080/group.seven/rest/hbase/insert/a0_accelerometer/letters/E/E1";
	...
	private void updateAccelerometerCals(BluetoothGattCharacteristic characteristic) {
		...
		String x = values[0].toString();
		String y = values[1].toString();
		String z = values[2].toString();
